...
const SlidCard = ({cardDetail,categoriId}) => {
  return (
    <div className='drop-shadow-lg p-3 mb-4 rounded-xl bg-white  border border-black  group transition-all duration-800 '>
    ...
    <div className="flex flex-col gap-2 px-1 py-3  mt-1 items-center rounded-md group-hover:bg-slate-400">
